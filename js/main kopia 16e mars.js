...
/*** Setting up map ***/
  ...
  function initMap() {
    map = new google.maps.Map(document.getElementById('map'), { /* get mp Div and fill with content */
...
/* 
Replace with this fetch+url when publishing online, it's safe, but seems slower:
